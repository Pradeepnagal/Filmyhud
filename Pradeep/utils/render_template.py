...
from Pradeep.utils.file_properties import get_file_ids
from Pradeep.server.exceptions import InvalidHash
import urllib.parse
import aiofiles
import logging
import aiohttp
...
async def render_page(id, secure_hash):
    ...
    if str(file_data.mime_type.split('/')[0].strip()) == 'video':
        ...
        async with aiofiles.open('Pradeep/template/dl.html') as r:
